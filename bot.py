...
# Save the model and tokenizer with a specific name
new_model_name = "C:/Users/DELL/Downloads/newsave_model"  # Example path in Google Drive
ners.model.save_pretrained(new_model_name)
ners.tokenizer.save_pretrained(new_model_name)

# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('C:/Users/DELL/Downloads/chatbot_modelsave','rb'))
model,second_le  = pk.load(open('C:/Users/DELL/Downloads/chatbot_model','rb'))
...
# Load the saved model
new_model_name = "C:/Users/DELL/Downloads/newsave_model"  # Example path in Google Drive
ners = pipeline(task="ner", model=new_model_name, tokenizer=new_model_name)

# Load NN Model 
FILE = "C:/Users/DELL/Downloads/data.pth"
...
def tree_to_code(disease_input):
    ...
    if conf==1:
        if len(cnf_dis) > 1:
            output = f"Are you suffering from this type of ' {desies} ' ? Please confirm that: \n"
